/* 
  In preparation for the Philly Science Festival 2019
  Changed the sense of direction for alt/az due to a change in wiring
*/
...
long previous_ms_read = 0;
long previous_ms_write = 0;
long read_interval = 2;
...
void TakeSteps(int steps)
{
  ...
  if(current_ms - previous_ms_read >= read_interval) {
    previous_ms_read = current_ms;
    i = i+1;
    voltage_sum = voltage_sum + voltage;
    voltage_avg = voltage_sum / i;
  }
}
